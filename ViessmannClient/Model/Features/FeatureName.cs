...
namespace ViessmannClient.Model.Features
{
    public class FeatureName
    {
        ...
        private static readonly Dictionary<string, Name> _mapping = new()
        {
            ...
            {"heating.burners.{circuit}", Name.HeatingBurner},
            {"heating.burners.{circuit}.automatic", Name.HeatingBurnerAutomatic},
            {"heating.burners.{circuit}.modulation", Name.HeatingBurnerModulation},
            {"heating.burners.{circuit}.statistics", Name.HeatingBurnerStatistics},
